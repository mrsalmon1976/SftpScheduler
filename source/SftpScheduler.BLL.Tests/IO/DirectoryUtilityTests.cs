...
namespace SftpScheduler.BLL.Tests.IO
{
    ...
    public class DirectoryUtilityTests
    {
        ...
        public void CopyRecursive_WithDirectoryInfoArguments_CopiesRootFiles()
        {
            ...
            // execute
            IDirectoryUtility dirUtility = new DirectoryUtility();
            dirUtility.CopyRecursive(new DirectoryInfo(sourceFolder), new DirectoryInfo(destinationFolder));
        ...
        public void CopyRecursive_WithStringArguments_CopiesRootFiles()
        {
            ...
            // execute
            IDirectoryUtility dirUtility = new DirectoryUtility();
            dirUtility.CopyRecursive(sourceFolder, destinationFolder);
        ...
        public void CopyRecursive_WithFileExclusions_DoesNotCopyExcludedFiles()
        {
            ...
            dirUtility.CopyRecursive(sourceFolder, destinationFolder, excludedFilesWithFullPath);
        ...
        public void DeleteContents_WithStringArguments_DeletesAllSubFolders()
        {
            ...
            // execute
            IDirectoryUtility dirUtility = new DirectoryUtility();
            dirUtility.DeleteContents(sourceFolder);
        ...
        public void DeleteContents_WithExclusions_DeletesAllSubFoldersExceptForExcluded()
        {
            ...
            dirUtility.DeleteContents(sourceFolder, excludedArgs);
        ...
        [Test]
        public void Delete_OnExecute_DeletesFolderAndSubfolders()
        {
            // Set up
            string[] files = { "deleted.txt", "Folder1\\test1.txt", "Folder1\\Folder1_1\\Folder1_1_1\\test1_1_1.txt" };
            ...
            // execute
            IDirectoryUtility dirUtility = new DirectoryUtility();
            dirUtility.Delete(sourceFolder);
